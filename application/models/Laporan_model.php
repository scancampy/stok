...
ORDER BY tanggal ASC");
	...
	public function getBukuBank($idrekening = '', $tglawal = '', $tglakhir = '') {
		...
		$h = $this->db->query("SELECT hutangpiutang.nomor_nota, hutangpiutang.tanggal, 'HUTANG' as tipetrans, 'BAYAR HUTANG KE' as 'keterangantrans', pelanggan.nama AS 'kode', pelanggan.nama AS 'nama', hutangpiutang.keterangan AS 'keterangan', rekening.kode AS 'koderek', '' AS debit, hutangpiutang.nominal AS kredit, 'H' AS 'inisialkode'  
FROM hutangpiutang 
...
UNION
SELECT hutangpiutang.nomor_nota, hutangpiutang.tanggal, 'PIUTANG' as tipetrans,  'PIUTANG DARI' as 'keterangantrans', pelanggan.nama AS 'kode', pelanggan.nama AS 'nama', hutangpiutang.keterangan AS 'keterangan', rekening.kode AS 'koderek', hutangpiutang.nominal AS debit, '' AS kredit , 'P' AS 'inisialkode'  
FROM hutangpiutang
INNER JOIN pelanggan ON pelanggan.idpelanggan = hutangpiutang.idpelanggan
INNER JOIN rekening ON rekening.idrekening = hutangpiutang.idrekening
...
ORDER BY tanggal ASC");
	...
	public function getSaldoAwal($idrekening = '', $tglawal = '') {
		$h = $this->db->query("SELECT hutangpiutang.nomor_nota, hutangpiutang.tanggal, 'HUTANG' as tipetrans, 'BAYAR HUTANG KE' as 'keterangantrans', pelanggan.nama AS 'kode', hutangpiutang.keterangan AS 'keterangan', rekening.kode AS 'koderek', '' AS debit, hutangpiutang.nominal AS kredit  
FROM hutangpiutang 
INNER JOIN pelanggan ON pelanggan.idpelanggan = hutangpiutang.idpelanggan
INNER JOIN rekening ON rekening.idrekening = hutangpiutang.idrekening
...
UNION
SELECT hutangpiutang.nomor_nota, hutangpiutang.tanggal, 'PIUTANG' as tipetrans,  'PIUTANG DARI' as 'keterangantrans', pelanggan.nama AS 'kode', hutangpiutang.keterangan AS 'keterangan', rekening.kode AS 'koderek', hutangpiutang.nominal AS debit, '' AS kredit 
FROM hutangpiutang
INNER JOIN pelanggan ON pelanggan.idpelanggan = hutangpiutang.idpelanggan
INNER JOIN rekening ON rekening.idrekening = hutangpiutang.idrekening
