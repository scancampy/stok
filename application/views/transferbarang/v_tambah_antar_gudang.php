  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php if($this->input->get('id')) { echo 'EDIT TRANSFER ANTAR GUDANG'; } else { echo 'TAMBAH TRANSFER ANTAR GUDANG'; } ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title">
                  <?php if($this->input->get('id')) { echo 'EDIT TRANSFER ANTAR GUDANG'; } else { echo 'TAMBAH TRANSFER ANTAR GUDANG'; } ?></h3>
              </div>
              <form method="post" action="<?php echo base_url('transferbarang/tambahantargudang'); ?>" id="formtmabahhutang" name="formtmabahhutang">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" 
    <?php if($this->input->get('id')) { echo 'readonly value="'.$editnota[0]->nomor_nota.'"'; } else { echo ' value="'.$lastid.'" '; }   ?>  class="form-control" autofocus id="nomor_nota" name="nomor_nota" >
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="idgudang_tujuan">GUDANG TUJUAN</label>
                    <select class="custom-select rounded-0" id="idgudang_tujuan" name="idgudang_tujuan">
                      <option value="">[PILIH GUDANG]</option>
                      <?php foreach($gudang as $k) { ?>
                      <option value="<?php echo $k->idgudang; ?>" alamat="<?php echo $k->alamat; ?>" <?php if($this->input->get('id')) { if($k->idgudang == $editnota[0]->idgudang_tujuan) { echo 'selected="selected" '; } } ?>><?php echo strtoupper($k->nama); ?></option>
                      <?php } ?>
                    </select>

                    <span class="help-block" id='helpgudangtujuan' style="display: none;" >
                      TES
                    </span>
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="card-footer" >
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="btnsubmit" id="btnsubmit" value="submit" class="btn btn-primary">SIMPAN TRANSFER ANTAR GUDANG</button>
                  </div>
                </div>
              </form>
            </div>
