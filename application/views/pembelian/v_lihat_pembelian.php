  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <form method="get" action="<?php echo base_url('pembelian/lihatpembelian'); ?>" id="formlihatpembelian">
              <div class="card">
                <div class="card-header" >
                  <div class='col-md-12 d-flex justify-content-between'>
                    <h3 class="card-title">DATA PEMBELIAN</h3> <a href="<?php echo base_url('pembelian/tambah'); ?>" class="btn btn-primary btn-sm" id="btnadd" >TAMBAH PEMBELIAN</a>
                  </div>
                </div>
                <div class="card-body">
                  <div class="row">
                  ...
                  <table>
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>B<?php echo strtoupper($b->nomor_nota); ?></td>
                            <td><?php echo strtoupper($b->pelanggannama); ?></td>
                            <td><?php echo strtoupper(strftime("%d %B %Y", strtotime($b->tanggal_terima))); ?></td>
                          ...
                          <td><a href="<?php echo base_url('pembelian/tambah?id='.$b->nomor_nota); ?>" class="btn btn-info btn-sm btnedit"><i class="far fa-edit nav-icon"></i> EDIT</a>

                          <a href="<?php echo base_url('pembelian/del/'.$b->nomor_nota); ?>" class="btn btn-danger btn-sm btntrash" onclick="return confirm('YAKIN HAPUS?');"><i class="far fa-trash-alt nav-icon"></i> HAPUS</a>
                          </td>
                        </tr>
                         <?php } 
                          ?>
