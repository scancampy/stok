  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php if($this->input->get('id')) { echo 'EDIT RETUR'; } else { echo 'TAMBAH RETUR PEMBELIAN'; } ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title">
                  <?php if($this->input->get('id')) { echo 'EDIT RETUR'; } else { echo 'TAMBAH RETUR PEMBELIAN'; } ?></h3>
              </div>
              <form method="post" action="<?php echo base_url('pembelian/tambahretur'); ?>" id="formtmabahretur" name="formtmabahretur">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                        <label for="nomor_nota">NOMOR RETUR PEMBELIAN</label>
                ...
                <div class="card-footer" >
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="btnsubmit" id="btnsubmit" value="submit" class="btn btn-primary">SIMPAN RETUR PEMBELIAN</button>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <span class="help-block text-gray">CARI NAMA / CONTACT PERSON / ALAMAT / TELEPON SUPPLIER</span>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <span class="help-block text-gray">CARI NOMOR NOTA / NAMA PELANGGAN / NAMA GUDANG</span>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" min="0" class="form-control" name="jumlah_besar" id="jumlah_besar" >
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" min="0" class="form-control" id="jumlah_kecil" name="jumlah_kecil" >
                      <div class="input-group-append">
