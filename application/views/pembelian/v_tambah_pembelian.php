  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php if($this->input->get('id')) { echo 'EDIT PEMBELIAN'; } else { echo 'TAMBAH PEMBELIAN'; } ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title">
                  <?php if($this->input->get('id')) { echo 'EDIT PEMBELIAN'; } else { echo 'TAMBAH PEMBELIAN'; } ?></h3>
              </div>
              <form method="post" action="<?php echo base_url('pembelian/tambah'); ?>" id="formtmabahpembelian" name="formtmabahpembelian">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                        <label for="nomor_nota">NOMOR BUKTI PEMBELIAN</label>
                  ...
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                        <label for="namapelanggan">SUPPLIER</label>
                        <div class="input-group">
                        ...
                        <input type="hidden" name="hididpelanggan" id="hididpelanggan" <?php if($this->input->get('id')) { echo ' value="'.$editnota[0]->idsupplier.'"'; }  ?>>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <label for="">&nbsp;</label>
                      <div class="input-group">
                        ...
                        <button type="button"  data-toggle="modal" data-target="#modal-lg" class="btn btn-info "><i class="fas fa-search"></i> CARI SUPPLIER</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  name="nomor_faktur" <?php if($this->input->get('id')) { echo ' value="'.$editnota[0]->nomor_faktur.'"'; }  ?>  class="form-control" id="nomor_faktur" >
                  </div>

                  <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <label for="tanggalterima">TANGGAL TERIMA BARANG</label>
                 <div class="input-group date" id="tanggalterima" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input tanggalterima"  id="tanggalterima" name="tanggalterima" data-target="#tanggalterima" <?php if($this->input->get('id')) { echo ' value="'.date("d F Y", strtotime($editnota[0]->tanggal_terima)).'"'; } else { echo ' value="'.date("d F Y").'"'; }    ?>/>
                    <div class="input-group-append" data-target="#tanggalterima" data-toggle="datetimepicker">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="jatuhtempo">TANGGAL JATUH TEMPO</label>
                 <div class="input-group date" id="jatuhtempo" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input jatuhtempo"   id="jatuhtempo" name="jatuhtempo" data-target="#jatuhtempo" <?php if($this->input->get('id')) { echo ' value="'.date("d F Y", strtotime($editnota[0]->tanggal_jatuh_tempo)).'"'; } else { echo ' value="'.date("d F Y").'"'; }   ?>/>
                    <div class="input-group-append" data-target="#jatuhtempo" data-toggle="datetimepicker">
                        <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                    </div>
                </div>
              </div>
                      ...
                      <div class="card card-light">
                        <div class="card-header" >
                          <div class='col-md-12 d-flex justify-content-between'>
                            <h3 class="card-title">
                              DETAIL BARANG
                            </h3><button class="btn btn-info btn-sm" id="btnadd" data-toggle="modal" data-target="#modal-tambah-produk-lg" type="button">TAMBAH BARANG</button>
                          </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="card-footer" >
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="btnsubmit" id="btnsubmit" value="submit" class="btn btn-primary">SIMPAN PEMBELIAN</button>
                  </div>
                </div>
              </form>
            </div>
  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id='title_modal'>CARI SUPPLIER</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <span class="help-block text-gray">CARI NOMOR NOTA / NOMOR FAKTUR / NAMA SUPPLIER / NAMA GUDANG</span>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2bs4" name="selectbarang" id="selectbarang" style="width: 100%;">
                  ...
                  <option satuanbesar='<?php echo $b->satuan_besar; ?>' satuankecil='<?php echo $b->satuan_kecil; ?>' namabarang='<?php echo $b->nama; ?>' kodebarang='<?php echo $b->kode; ?>' value="<?php echo $b->idbarang; ?>"><?php echo strtoupper($b->nama).' ('.strtoupper($b->kode).')'; ?></option>
                  <?php  } ?>
                </select>
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" min="0" class="form-control" name="jumlah_besar" id="jumlah_besar" >
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" min="0" class="form-control" id="jumlah_kecil" name="jumlah_kecil" >
                      <div class="input-group-append">
