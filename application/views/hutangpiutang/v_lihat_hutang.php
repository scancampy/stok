  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">LIHAT PEMBAYARAN HUTANG</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <form method="get" action="<?php echo base_url('hutangpiutang/lihathutang'); ?>" id="formlihatpenjualan">
              <div class="card">
                <div class="card-header" >
                  <div class='col-md-12 d-flex justify-content-between'>
                    <h3 class="card-title">DATA PEMBAYARAN HUTANG</h3> <a href="<?php echo base_url('hutangpiutang/tambahhutang'); ?>" class="btn btn-primary btn-sm" id="btnadd" >TAMBAH PEMBAYARAN HUTANG</a>
                  </div>
                </div>
                <div class="card-body">
                  <div class="row">
                  ...
                  <table>
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>H<?php echo strtoupper($b->nomor_nota); ?></td>
                          ...
                          <td><a href="<?php echo base_url('hutangpiutang/tambahhutang?id='.$b->nomor_nota); ?>" class="btn btn-info btn-sm btnedit"><i class="far fa-edit nav-icon"></i> EDIT</a>
