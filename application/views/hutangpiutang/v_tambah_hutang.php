  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php if($this->input->get('id')) { echo 'EDIT PEMBAYARAN HUTANG'; } else { echo 'TAMBAH PEMBAYARAN HUTANG'; } ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title">
                  <?php if($this->input->get('id')) { echo 'EDIT PEMBAYARAN HUTANG'; } else { echo 'TAMBAH PEMBAYARAN HUTANG'; } ?></h3>
              </div>
              <form method="post" action="<?php echo base_url('hutangpiutang/tambahhutang'); ?>" id="formtmabahhutang" name="formtmabahhutang">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                ...
                <div class="card-footer" >
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="btnsubmit" id="btnsubmit" value="submit" class="btn btn-primary">SIMPAN PEMBAYARAN HUTANG</button>
                  </div>
                </div>
              </form>
            </div>
