  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">LIHAT PENJUALAN RETUR</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <form method="get" action="<?php echo base_url('penjualan/lihatreturpenjualan'); ?>" id="formlihatpenjualan">
              <div class="card">
                <div class="card-header" >
                  <div class='col-md-12 d-flex justify-content-between'>
                    <h3 class="card-title">DATA RETUR PENJUALAN</h3> <a href="<?php echo base_url('penjualan/tambahretur'); ?>" class="btn btn-primary btn-sm" id="btnadd" >TAMBAH RETUR PENJUALAN</a>
                  </div>
                </div>
                <div class="card-body">
                  <div class="row">
                  ...
                  <table>
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <a href="<?php echo base_url('penjualan/delretur/'.$b->nomor_nota); ?>" class="btn btn-danger btn-sm btntrash" onclick="return confirm('Yakin hapus?');"><i class="far fa-trash-alt nav-icon"></i> HAPUS</a>
                          </td>
                        </tr>
                         <?php } 
                          ?>
