  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php if($this->input->get('id')) { echo 'EDIT PENJUALAN'; } else { echo 'TAMBAH PENJUALAN'; } ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title">
                  <?php if($this->input->get('id')) { echo 'EDIT PENJUALAN'; } else { echo 'TAMBAH PENJUALAN'; } ?></h3>
              </div>
              <form method="post" action="<?php echo base_url('penjualan/tambah'); ?>" id="formtmabahpenjualan" name="formtmabahpenjualan">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">

                      <div class="form-group">
                        <label for="nomor_nota">NOMOR NOTA PENJUALAN</label>
              ...
              <div class="form-group">
                <label for="tanggaljual">TANGGAL PENJUALAN</label>
                 <div class="input-group date" id="tanggaljual" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input tanggaljual"  id="tanggaljual" name="tanggaljual" data-target="#tanggaljual" <?php if($this->input->get('id')) { echo ' value="'.date("d F Y", strtotime($editnota[0]->tanggal_jual)).'"'; } else { echo ' value="'.date("d F Y").'"'; }  ?>/>
              ...
              <div class="form-group">
                ...
                <div class="card-footer" >
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="btnsubmit" id="btnsubmit" value="submit" class="btn btn-primary">SIMPAN PENJUALAN</button>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <span class="help-block text-gray">CARI NOMOR NOTA / NOMOR FAKTUR / NAMA PELANGGAN / NAMA GUDANG</span>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
