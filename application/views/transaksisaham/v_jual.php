  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php if($this->input->get('id')) { echo 'EDIT JUAL SAHAM'; } else { echo 'JUAL SAHAM'; } ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header" >
                <h3 class="card-title">
                  <?php if($this->input->get('id')) { echo 'EDIT JUAL SAHAM'; } else { echo 'JUAL SAHAM'; } ?></h3>
              </div>
              <form method="post" action="<?php echo base_url('transaksisaham/jual'); ?>" id="formtmabahpenjualan" name="formtmabahpenjualan">
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                        <label for="nomor_nota">NOMOR NOTA JUAL SAHAM</label>
                        <div class="input-group">
                          <div class="input-group-prepend">
                            <span class="input-group-text">JSH</span>
                          </div>
          ...
          <div class="form-group" style="display: none;">
                ...
                <div class="card-footer" >
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="btnsubmit" id="btnsubmit" value="submit" class="btn btn-primary">SIMPAN PENJUALAN SAHAM</button>
                  </div>
                </div>
              </form>
            </div>
