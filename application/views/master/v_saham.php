            ...
            <div class="card">
              <div class="card-header" >
                <div class='col-md-12 d-flex justify-content-between'>
                  <h3 class="card-title">DATA MASTER SAHAM</h3> <a href="#" class="btn btn-primary btn-sm" id="btnadd" data-toggle="modal" data-target="#modal-lg">TAMBAH SAHAM</a>
                </div>
              </div>
              <div class="card-body">
                <table>
                  <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        <td class="text-center"><a href="#" style="padding: 0 5px;" sahamid="<?php echo $b->idsaham; ?>" data-toggle="modal" data-target="#modal-lg" class="btn btn-info btn-sm btnedit"><i class="far fa-edit nav-icon"></i> EDIT</a>

                        <a href="<?php echo base_url('saham/del/'.$b->idsaham); ?>" class="btn btn-danger btn-sm btntrash" onclick="return confirm('Yakin hapus?');" style="padding: 0 5px;"><i class="far fa-trash-alt nav-icon"></i> HAPUS</a>
                        </td>
                      </tr>
                       <?php } 
                        ?>
...
<div class="modal fade" id="modal-lg">
  <div class="modal-dialog modal-lg">
    <form action="<?php echo base_url('saham'); ?>" method="post">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id='title_modal'>TAMBAH SAHAM</h4>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-md-7">
               <input type="hidden" name="hididsaham" id="hididsaham" />
              ...
              <div class="form-group">
                <label for="nama">NAMA SAHAM</label>
            ...
            <div class="col-md-5">
              <div class="form-group">
                <label for="satuan_kecil">SAHAM SERUPA</label>
